...
standata$priors <- 0
empty_stanmodel <- stan("models/gamma_qpoisson_hsy.stan", data = standata, iter = 0, chains = 0)
...
standata$priors <- 0
empty_stanmodel <- stan("models/gamma_qpoisson_hysyd.stan", data = standata, iter = 0, chains = 0)
